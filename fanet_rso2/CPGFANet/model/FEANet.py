...
class FEANet(nn.Module):
    ...
    def __init__(self, n_class, pretrained_backbone=True):
        super(FEANet, self).__init__()

        self.num_resnet_layers = 152

        resnet_kwargs = {'weights': None} if not pretrained_backbone else {}
        ...
        if self.num_resnet_layers == 50:
            if pretrained_backbone:
                ...
                resnet_raw_model1 = models.resnet50(**resnet_kwargs)
                resnet_raw_model2 = models.resnet50(**resnet_kwargs)
            self.inplanes = 2048
        elif self.num_resnet_layers == 101:
            if pretrained_backbone:
                resnet_raw_model1 = models.resnet101(weights=models.ResNet101_Weights.IMAGENET1K_V1)
                resnet_raw_model2 = models.resnet101(weights=models.ResNet101_Weights.IMAGENET1K_V1)
            else:
                resnet_raw_model1 = models.resnet101(**resnet_kwargs)
                resnet_raw_model2 = models.resnet101(**resnet_kwargs)
            self.inplanes = 2048
        elif self.num_resnet_layers == 152:
            if pretrained_backbone:
                resnet_raw_model1 = models.resnet152(weights=models.ResNet152_Weights.IMAGENET1K_V1)
                resnet_raw_model2 = models.resnet152(weights=models.ResNet152_Weights.IMAGENET1K_V1)
            else:
                resnet_raw_model1 = models.resnet152(**resnet_kwargs)
                resnet_raw_model2 = models.resnet152(**resnet_kwargs)
            self.inplanes = 2048
