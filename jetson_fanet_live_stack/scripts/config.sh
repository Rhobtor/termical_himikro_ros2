...
export FANET_MODEL_WIDTH=448
export FANET_MODEL_HEIGHT=352
...
export FANET_GUI_PUBLISH_RGB_IMAGE=1
export FANET_GUI_PUBLISH_RGB_COMPRESSED=0
export FANET_GUI_PUBLISH_THERMAL_IMAGE=0
export FANET_GUI_PUBLISH_THERMAL_COMPRESSED=0
export FANET_OUTPUT_DIR=${STACK_ROOT}/../fanet_rso2/CPGFANet/ros2_outputs
export FANET_SYNC_RATE=25.0
